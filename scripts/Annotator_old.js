 ...
 * @param annotationTypes - Array of objects with keys 'label' (String) and 'color' (String): the annotation options
...
function Annotator(text, annotationTypes, highlightingColor, textPanelId, annotationTypePanelId) {
    ...
    function onMouseUp() {
        ...
        if (!selection.anchorNode || !selection.focusNode || (selection.anchorNode == selection.focusNode && selection.anchorOffset == selection.focusOffset &&
            anchorNodeSpan.style.backgroundColor != highlightingColor)) {
        ...
        //split from neighbouring words eventually
